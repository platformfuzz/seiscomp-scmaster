...
COPY docker/entrypoint.sh docker/write-runtime-config.sh docker/run-scmaster.sh /docker/

RUN chmod 0755 /docker/entrypoint.sh /docker/write-runtime-config.sh /docker/run-scmaster.sh
